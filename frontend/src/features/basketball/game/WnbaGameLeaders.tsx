...
import type { GameDetail, GameDetailGameLeaderCard } from "../lib/types";

function GameLeaderHeadshot({ card }: { card: GameDetailGameLeaderCard }) {
...
export function WnbaGameLeaders({ detail }: { detail: GameDetail }) {
